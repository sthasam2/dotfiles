-- Code for the "plug" interface that will be used in the init.lua file
-- This is a simple wrapper around vim-plug that will allow us to
-- colocate plugin configuration with the plugin declaration
--
-- Reference: More like stolen, from https://dev.to/vonheikemen/neovim-using-vim-plug-in-lua-3oom
local configs = {
    lazy = {},
    start = {}
}
